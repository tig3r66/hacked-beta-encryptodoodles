...
def encrypt(text, rotoro1, rotoro2, rotoro3, rotorp1, rotorp2, rotorp3):
    # user input rotor ordering
    rotor_order = [int(rotoro1), int(rotoro2), int(rotoro3)]

    # user input the rotor positions
    initial_pos = [int(rotorp1) - 1, int(rotorp2) - 1, int(rotorp3) - 1]
...
def decrypt(text, rotoro1, rotoro2, rotoro3, rotorp1, rotorp2, rotorp3):
    # user input rotor ordering
    rotor_order = [int(rotoro1), int(rotoro2), int(rotoro3)]
